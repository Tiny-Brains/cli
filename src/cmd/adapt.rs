...
//!
//! **This exists because an adapter is half of what plays, and nothing else shows you what it
//! actually produced.** `check` reports shapes; a competitor training in Python encodes
